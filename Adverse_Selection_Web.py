...
# web body - C
    ...
    st.write("**Original AVERAGE prices:** B=${}, S=${}, G=${}".format(Bronze_raw, Silver_raw, Gold_raw))
    st.write("**Current AVERAGE prices:** B=${}, S=${}, G=${}".format(Bronze_average, Silver_average, Gold_average))
